            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                @endif
                  ...
                  <form class="row g-3 needs-validation" novalidate action="{{route('loginmatch')}}" method="post">
                  @csrf
                    <div class="col-12">
                      <label for="mobile" class="form-label">Mobile</label>
                      <input type="tel" name="mobile" class="form-control" id="mobile" required pattern="[0-9]{10}">
                      <div class="invalid-feedback">Please enter your mobile number (10 digits).</div>
                    </div>
