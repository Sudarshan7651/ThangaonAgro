...
<head>
    <meta charset="utf-8">
    <title>ThangaonAgro - Login</title>
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class="auth-card wow fadeInUp" data-wow-delay="0.1s">
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">Login to manage your orders</p>
                </div>
                ...
                <div class="auth-body">
                    ...
                    <form class="row g-3 needs-validation" action="{{route('loginmatch')}}" method="post" novalidate>
                        @csrf
                        
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="tel" name="mobile" class="form-control" id="mobile" placeholder="Mobile Number" required pattern="[0-9]{10}">
                        ...
                        <div class="col-12 text-center mt-3">
                            <p class="small mb-0">Don't have an account? <a href="{{route('register')}}" class="register-link">Create Account</a></p>
                        </div>
                    </form>
                </div>
            </div>
